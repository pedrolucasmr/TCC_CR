                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Relatórios<small> Admnistradores</small>
                        </h1>
                <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <a href="listall/listall_adm.php">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <form method="post" action="consulta_adm.php">
                                    <div class="cols-md-12">
								
									<br><input type="text" class="form-control" name="consulta_adm" id="consulta_adm"  placeholder="Digite o nome"/>
