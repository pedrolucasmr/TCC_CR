    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../index_adm.php">Lopes advocacia</a>
            </div>
            <!-- Top Menu Items -->
                   ...
                   <li>
                      <a href="javascript:;" data-toggle="collapse" data-target="#adm_options"><i class="fa fa-fw fa-arrows-v"></i>Administradores <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="adm_options" class="collapse">
                            <li>
                                <a href="relatorio_adm.php">Listar Administradores</a>
                    ...
                    <li>
                      <a href="javascript:;" data-toggle="collapse" data-target="#adv_options"><i class="fa fa-fw fa-arrows-v"></i>Advogados <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="adv_options" class="collapse">
                            <li>
                                <a href="relatorio_advogado.php">Listar Advogados</a>
                    ...
                    <li>
                        ...
                        <ul id="func_option" class="collapse">
                            <li>
                                <a href="relatorio_funcionario.php">Listar Funcionários</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Relatórios<small> Advogados</small>
                        </h1>
                <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <a href="listall/listall_adv.php">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <form method="post" action="consulta_adv_nome.php">
                                    <div class="cols-md-12">
									   <br><input type="text" class="form-control" name="consulta_adv_nome" id="consulta_adv"  placeholder="Digite o nome"/>  
                                    </div>
						</div>
                                </div>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <form method="post" action="consulta_adv_id.php">
                                    <div class="cols-md-12">
									   <br><input type="text" class="form-control" name="consulta_adv_id" id="consulta_adv"  placeholder="Digite o ID"/>  
                                    </div>
						</div>
                                </div>
                            <button type=submit class="btn btn-primary btn-lg btn-block login-button">Consultar</button>  </form>
