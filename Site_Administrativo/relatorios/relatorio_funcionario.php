                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Relatórios<small> Funcionários</small>
                        </h1>
                <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <a href="listall/listall_func.php">
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div>Listar por cargo</div>
                                    </div>
                                </div>
                            </div>
                            <a href="../pdf/listcargo_func.php">
                                <div class="panel-footer">
                                    <span class="pull-left">Listar</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-9 text-left">                    </div>
                                        <div><h2>Faça uma consulta: <br></h2></div>
                                    </div>
                                    <form method="post" action="consulta_func_nome.php">
                                    <div class="cols-md-12">
								
									<br><input type="text" class="form-control" name="consulta_func" id="consulta_func"  placeholder="Digite o nome"/>
