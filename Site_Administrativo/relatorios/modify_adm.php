...
$campo=$_POST['campo'];
$mod=$_POST['mod'];
$sql4="SELECT * FROM admnistrador WHERE nome='$consulta_value'";
$sql5="SELECT * FROM admnistrador WHERE cpf='$registro'";
if($campo=='nome'){
$sql1="UPDATE admnistrador SET nome='$mod' WHERE cpf='$registro'";
...
$sql2="UPDATE admnistrador SET email='$mod' WHERE cpf='$registro'";
...
$sql3="UPDATE admnistrador SET telefone='$mod' WHERE cpf='$registro'";
