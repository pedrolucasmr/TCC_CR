...
$campo=$_POST['campo'];
$mod=$_POST['mod'];
$sql4="SELECT * FROM funcionario WHERE cpf_func='$registro'";
if($campo=='nome'){
$sql1="UPDATE funcionario SET nome='$mod' WHERE cpf_func='$registro'";
...
$sql2="UPDATE funcionario SET email='$mod' WHERE cpf_func='$registro'";
...
$sql3="UPDATE funcionario SET telefone='$mod' WHERE cpf_func='$registro'";
